      ...
      <section className="pb-0">
        ...
        <div className="bg-white p-2">
          <div className="container flex gap-3">
            <div
              className={`sidebarWrapper fixed -bottom-[100%] left-0 w-full lg:h-full lg:static lg:w-[20%] bg-white z-[10000] lg:z-[100] p-3 lg:p-0 transition-all lg:opacity-100 opacity-0 ${
