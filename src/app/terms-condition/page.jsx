          ...
          <div className="lg:col-span-3">
            <div className="space-y-10">
              ...
              <section className="scroll-mt-20">
                ...
                <p className="text-muted-foreground">{t("terms.welcomep1")}</p>
              </section>
              ...
              <section id="Account" className="scroll-mt-20">
                ...
                <p className="text-muted-foreground">{t("terms.accountp5")}</p>
              </section>
              ...
              <section id="Reviews" className="scroll-mt-20">
                ...
                <p className="text-muted-foreground">{t("terms.reviewsp6")}</p>
              </section>
              ...
              <section id="Other-Businesses" className="scroll-mt-20">
                ...
                <p className="text-muted-foreground">{t("terms.businessp2")}</p>
              </section>
              ...
              <section id="Children" className="scroll-mt-20">
                ...
                <p className="text-muted-foreground">{t("terms.childrenp1")}</p>
              </section>
              ...
              <section id="Customs" className="scroll-mt-20">
                ...
                <p className="text-muted-foreground">{t("terms.customsP2")}</p>
              </section>
