      ...
      <ul className="list-none pb-5 bg-[#f1f1f1] myAccountTabs">
        <li className="w-full">
          <NavLink href="/my-account" activeClassName="active">
            <Button className="w-full !text-left !py-2 !px-5 !justify-start !capitalize !text-[rgba(0,0,0,0.8)] !rounded-none flex items-center gap-2">
              <FaRegUser className="text-[15px]" /> {t("accountSb.myProfile")}
            </Button>
          </NavLink>
        </li>
        ...
        <li className="w-full">
          <NavLink href="/my-account/address" activeClassName="active">
            <Button className="w-full !text-left !py-2 !px-5 !justify-start !capitalize !text-[rgba(0,0,0,0.8)] !rounded-none flex items-center gap-2">
              <LuMapPin className="text-[18px]" /> {t("accountSb.address")}
            </Button>
          </NavLink>
        </li>
        ...
        <li className="w-full">
          <NavLink href="/my-list" activeClassName="active">
            <Button className="w-full !py-2  !text-left !px-5 !justify-start !capitalize !text-[rgba(0,0,0,0.8)] !rounded-none flex items-center gap-2">
              <IoMdHeartEmpty className="text-[17px]" /> {t("accountSb.myList")}
            </Button>
          </NavLink>
        </li>
        ...
        <li className="w-full">
          <Button
            ...
            onClick={logout}
          >
            <IoIosLogOut className="text-[18px]" /> {t("accountSb.logout")}
          </Button>
        </li>
      </ul>
    </div>
