export const translations = {
  en: {
    ...
    privacy: {
      ...
      gdprP1:
        "For EU/EEA users, we process personal data in accordance with the General Data Protection Regulation (GDPR).",
      ...
      caHeading: "California Privacy Rights",
      caP1: "California residents have specific rights under CCPA/CPRA.",
      caRightsHeading: "Your Rights Under CCPA/CPRA",
      c1: "Right to Know",
      c2: "Right to Delete",
      c3: "Right to Opt-Out of Sale",
      c4: "Right to Non-Discrimination",
      c5: "Right to Correct",
      c6: "Right to Limit Use of Sensitive Information",
      caNote: "To exercise these rights, contact us using the details below.",

      contactHeading: "Contact Information",
      contactP1:
        "If you have questions about this Privacy Policy, contact us at:",
      contactName: "SOOUQNA Privacy Team",
      contactEmail: "Email: privacy@soouqna.com",
      contactPhone: "Phone: +1 (555) 123-4567",
      contactAddress:
        "Address: 123 Commerce Street, Business District, City, Country",
      contactP2:
        "EU/EEA data subjects may also contact our DPO at dpo@soouqna.com.",
  ...
  ar: {
    ...
    footer: {
      ...
      description:
        "تأسست سوقنا في عام 2020 بهدف بسيط وهو إنشاء سوق إلكتروني يربط العملاء بمنتجات عالية الجودة...",
    ...
    home: {
      ...
      freeShippingDesc: "توصيل مجاني الآن على أول طلب لك وأكثر من دولار",
      onlyPrice: "- فقط دولار*",
    ...
    product: {
      ...
      returnHeading: "استرجاع خلال يوم واحد",
      returnDesc: "الإلغاء بعد يوم واحد",
      paymentHeading: "دفع آمن",
      paymentDesc: "ضمان الدفع الآمن",
      hotlineHeading: "طلب عبر الخط الساخن:",
      hotlineDesc: "من الاثنين إلى الجمعة: ",
    },
    cartPage: {
      title: "سلة التسوق الخاصة بك",
      there: "هناك",
      productsInCart: "المنتجات في سلة التسوق الخاصة بك",
    ...
    checkout: {
      ...
      coupon: "استخدام قسيمة",
      couponInput: "أدخل رمز القسيمة",
      apply: "تطبيق",
      coupons: "القسائم المتاحة",
      ...
      area: "المنطقة / الشارع",
      confirm: "تأكيد",
      emptyCoupon: "يرجى إدخال رمز القسيمة",
    ...
    contact: {
      ...
      heroSubtitle:
        "نحن هنا للإجابة على أسئلتك ومساعدتك في الاستفادة القصوى من سوقنا.",
      callUs: "اتصل بنا",
      email: "البريد الإلكتروني",
      liveChat: "الدردشة المباشرة",
      liveChatText: "اضغط على أيقونة واتساب في الزاوية للحصول على دعم فوري",
      hqHeading: "المقر الرئيسي",
      needHelp: "تحتاج مساعدة فورية؟",
      needHelpText:
        "عادةً ما يرد وكلاء الدعم لدينا خلال دقائق أثناء ساعات العمل.",
      whatsappBtn: "ابدأ دردشة واتساب",
    },

    about: {
      breadcrumb: "من نحن",
      heroTitle: "من نحن – سوقنا",
      heroP1:
        "تأسست سوقنا في عام 2020 برؤية طموحة تمزج بين التقاليد والابتكار لبناء سوق إلكتروني حديث يربط المتسوقين حول العالم بمنتجات موثوقة مختارة بعناية.",
      heroP2:
        'اسمنا مستوحى من الكلمة العربية "سوق"، مما يعكس جذورنا الثقافية وشغفنا بدمج روح التجارة التقليدية مع الفكر الرقمي المتطور.',
      heroImgAlt: "فريق يعمل معًا",
      ourStoryTitle: "قصتنا",
      storyP1:
        "بدأنا كمشروع صغير بخطوات متواضعة، وسرعان ما تطورنا إلى منصة شاملة تستقطب آلاف الزوار شهريًا وتخدم مجتمعًا متناميًا من البائعين والمشترين. نعمل يوميًا على تحسين تجربة التسوق ومنح كل بائع فرصة متكافئة للنمو بغض النظر عن حجمه أو خلفيته.",
      missionTitle: "مهمتنا",
      missionText:
        "نؤمن بأن التجارة يجب أن تكون شفافة وعادلة ومبنية على الثقة المتبادلة. مهمتنا تمكين رواد الأعمال والبائعين من الوصول إلى عملائهم بسهولة، مع توفير تجربة تسوق آمنة وممتعة ومنسقة بعناية للمشترين.",
      visionTitle: "رؤيتنا",
      visionText:
      ...
      diff3: "أدوات تحليل وأداء للبائعين",
      diff4: "بيئة عمل بلا عمولات أو رسوم شهرية",
      diff5: "التزام صارم بالجودة والشفافية",
      diff6: "مجتمع مبني على الثقة والتنوع",
      ctaP1:
        "في سوقنا، لا نبيع المنتجات فحسب — بل نبني مجتمعًا رقميًا مزدهرًا ينمو بالتعاون ويتوسع بالثقة ويزدهر بالتنوع.",
      ctaP2:
    ...
    privacy: {
      ...
      introP2:
        "يرجى قراءة سياسة الخصوصية بعناية. باستخدامك المنصة، فإنك تقر بأنك قرأت وفهمت ووافقت على بنودها. إذا كنت لا توافق، فلا تستخدم المنصة.",
      ...
      nonPersonalP: "معلومات لا تحدد هويتك مباشرة، مثل:",
      ...
      m1: "جمع مباشر: المعلومات التي تقدمها عند التسجيل أو الشراء أو التواصل مع الدعم.",
      m2: "جمع آلي: من خلال ملفات تعريف الارتباط وتقنيات التتبع.",
      m3: "مصادر خارجية: شركاء الأعمال ومقدمو التحليلات.",

      useHeading: "كيفية استخدام معلوماتك",
      useP1: "نستخدم المعلومات للأغراض التالية:",
      use1: "تقديم الخدمات ومعالجة الطلبات.",
      use2: "تخصيص تجربة التسوق واقتراح المنتجات.",
      use3: "التواصل بشأن الحساب أو الطلبات أو العروض.",
      use4: "التسويق والإعلانات المستهدفة.",
      use5: "تحسين المنصة والخدمات.",
      use6: "الأمان والكشف عن الاحتيال.",
      use7: "الالتزام بالقوانين والتنظيمات.",

      shareHeading: "مشاركة المعلومات والإفصاح",
      shareP1: "قد نشارك معلوماتك في الحالات التالية:",
      share1: "مقدمو الخدمات الخارجيون (الدفع، الشحن...).",
      share2: "شركاء الأعمال والعروض المشتركة.",
      share3: "الالتزامات القانونية أو القضائية.",
      share4: "حماية حقوقنا أو حقوق المستخدمين.",
      share5: "عمليات الدمج أو الاستحواذ.",
      share6: "بموافقتك الصريحة.",
      shareNote: "لا نبيع معلوماتك الشخصية لأطراف ثالثة لأغراض التسويق.",

      cookiesHeading: "ملفات تعريف الارتباط",
      cookiesP1:
        "نستخدم ملفات تعريف الارتباط وتقنيات مشابهة لتحليل نشاط التصفح.",
      cookieTypes: "أنواع ملفات تعريف الارتباط",
      ct1: "أساسية: ضرورية لوظائف الموقع.",
      ct2: "تحليلية: تساعدنا على فهم استخدام الموقع.",
      ct3: "وظيفية: تتذكر تفضيلاتك.",
      ct4: "استهدافية: لعرض إعلانات أكثر ملاءمة.",
      cookiesP2: "يمكنك التحكم في ملفات تعريف الارتباط من إعدادات المتصفح.",

      securityHeading: "أمن البيانات",
      securityP1: "نطبق تدابير تقنية وتنظيمية مناسبة لحماية معلوماتك.",
      securityP2: "تشمل إجراءاتنا:",
      sec1: "تشفير المعلومات الحساسة",
      sec2: "خوادم وشبكات آمنة",
      sec3: "عمليات تقييم أمني منتظمة",
      sec4: "ضوابط وصول للموظفين",
      sec5: "تدريب الموظفين على حماية البيانات",

      rightsHeading: "حقوقك وخياراتك",
      rightsP1: "قد يكون لك حقوق معينة، منها:",
      r1: "الحق في الوصول إلى معلوماتك.",
      r2: "تصحيح المعلومات غير الدقيقة.",
      r3: "حذف معلوماتك في بعض الحالات.",
      r4: "تقييد المعالجة.",
      r5: "قابلية نقل البيانات.",
      rightsNote: "للاستفادة من هذه الحقوق، تواصل معنا.",
      marketingHeading: "الاتصالات التسويقية",
      marketingP: "يمكنك إلغاء الاشتراك في رسائلنا التسويقية في أي وقت.",

      childrenHeading: "خصوصية الأطفال",
      childrenP:
        "المنصة غير مخصصة للأطفال دون 13 عامًا، ولا نجمع معلوماتهم عمدًا.",

      intlHeading: "نقل البيانات دوليًا",
      intlP: "قد تُنقل معلوماتك إلى دول أخرى مع اتخاذ تدابير حماية كافية.",

      changesHeading: "تغييرات سياسة الخصوصية",
      changesP:
        "قد نقوم بتحديث هذه السياسة دوريًا، وستكون التغييرات نافذة عند نشرها.",

      gdprHeading: "الامتثال للائحة GDPR",
      gdprP1: "نعالج بيانات مستخدمي الاتحاد الأوروبي وفقًا للائحة GDPR.",
      gdprLegalHeading: "أسس المعالجة القانونية",
      gdprLegalP: "نعتمد على الأسس القانونية التالية:",
      g1: "الموافقة",
      g2: "تنفيذ العقد",
      g3: "التزام قانوني",
      g4: "مصالح مشروعة",
      gdprDPOHeading: "ضابط حماية البيانات",
      gdprDPOP: "للاستفسارات، تواصل مع dpo@soouqna.com.",

      caHeading: "حقوق خصوصية كاليفورنيا",
      caP1: "يتمتع سكان كاليفورنيا بحقوق خاصة بموجب CCPA/CPRA.",
      caRightsHeading: "حقوقك بموجب CCPA/CPRA",
      c1: "الحق في المعرفة",
      c2: "الحق في الحذف",
      c3: "الحق في إلغاء بيع البيانات",
      c4: "الحق في عدم التمييز",
      c5: "الحق في التصحيح",
      c6: "الحق في تقييد استخدام المعلومات الحساسة",
      caNote: "لممارسة هذه الحقوق، تواصل معنا.",

      contactHeading: "معلومات الاتصال",
      contactP1: "لأي استفسار حول هذه السياسة، تواصل معنا:",
      contactName: "فريق خصوصية سوقنا",
      contactEmail: "البريد: privacy@soouqna.com",
      contactPhone: "الهاتف: ‎+1 (555) 123-4567",
      contactAddress:
        "العنوان: 123 شارع التجارة، الحي التجاري، المدينة، الدولة",
      contactP2:
        "يمكن لمستخدمي الاتحاد الأوروبي التواصل مع DPO على dpo@soouqna.com.",
    ...
    refund: {
      ...
      eligibility1:
        "يجب تقديم طلب الإرجاع خلال 5 أيام من تاريخ الاستلام. الطلبات بعد هذه الفترة قد لا تُقبل.",
      eligibility2:
      ...
      eligibility4: "يجب تقديم إثبات الشراء مثل رقم الطلب أو الإيصال.",
      eligibilityNote:
      ...
      step3:
        "الحصول على رقم تصريح الإرجاع (RMA): بعد الموافقة، سنرسل لك الرقم وتعليمات الشحن.",
      step4:
      ...
      stepsNote:
        "بعد استلام المنتج، سنقوم بفحصه للتأكد من استيفائه الشروط، وسيتم إخطارك عبر البريد الإلكتروني عند الانتهاء.",
      ...
      refund3:
        "رصيد المتجر: قد يُعرض رصيد متجر بدلاً من رد نقدي في بعض الحالات.",
      refund4: "طلبات الهدايا: سيتم إصدار رصيد متجر للمستلم في حالة الإرجاع.",
      ...
      exceptionsNote:
        "إذا استلمت أيًا من هذه المنتجات تالفة، يرجى التواصل معنا خلال 48 ساعة من الاستلام.",

      damagedHeading: "المنتجات التالفة أو المعيبة",
      damagedDesc:
        "إذا استلمت منتجًا تالفًا أو معيبًا، يرجى التواصل خلال 48 ساعة وتزويدنا بـ:",
      damagedInfo1: "رقم الطلب",
      damagedInfo2: "وصف الضرر أو العيب",
      damagedInfo3: "صور توضح الحالة",
      damagedSolutionsHeading: "سنعوضك عبر:",
      damagedSolution1: "إرسال منتج بديل (وفق التوفر)",
      damagedSolution2: "استرداد كامل يشمل رسوم الشحن",
      damagedSolution3: "رصيد متجر بقيمة المنتج زائد 10% تعويضًا",
      ...
      exchangeNote4:
        "إذا كان البديل غير متوفر، يمكنك اختيار استرداد أو رصيد متجر.",
